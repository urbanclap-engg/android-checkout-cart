...
public abstract class RecyclerViewItemFactory<T, CT> implements IItemFactory<T, RecyclerViewItemViewHolder<T, CT>> {
    ...
    RecyclerViewItemViewHolder<T, CT> create(@NonNull Context context,
                                             @NonNull ViewGroup parent,
                                             int viewType, @Nullable CartCallback<CT> cartCallback) {
        RecyclerViewItemViewHolder<T, CT> viewHolder = createViewHolder(context, parent, viewType);
        viewHolder.setCartCallback(cartCallback);
        return viewHolder;
    }

    @Override
    public abstract RecyclerViewItemViewHolder<T, CT> createViewHolder(@NonNull Context context,
                                                                       @NonNull ViewGroup parent,
                                                                       int viewType);
}
